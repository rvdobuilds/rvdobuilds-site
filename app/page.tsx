...
import homeVisual from "@/assets/images/home-visual.png";
    ...
    <div className="grid gap-12 md:grid-cols-12 md:items-center md:gap-12 lg:gap-16">
      <div className="md:col-span-7">
        ...
        <div className="mt-9 flex flex-wrap gap-3">
          ...
          <ButtonLink href="/about#work-with-me" variant="ghost">
            Work with me
          </ButtonLink>
        </div>
      </div>
      ...
      <div className="md:col-span-5">
        <div className="relative aspect-[4/5] w-full overflow-hidden rounded-2xl border border-[var(--border-subtle)] bg-card">
          <Image
            src={homeVisual}
            alt="Moonlit landscape representing quiet ambition and building in public"
            fill
